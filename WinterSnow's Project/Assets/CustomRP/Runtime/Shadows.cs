...
public class Shadows
{
    ...
    static readonly int otherShadowAtlasId = Shader.PropertyToID("_OtherShadowAtlas");
    static readonly int otherShadowMatricesId = Shader.PropertyToID("_OtherShadowMatrices");
    static readonly int otherShadowTilesId = Shader.PropertyToID("_OtherShadowTiles");
    ...
    static readonly int shadowPancakingId = Shader.PropertyToID("_ShadowPancaking");
    ...
    static readonly Vector4[] otherShadowTiles = new Vector4[maxShadowedOtherLightCount];

    static readonly Matrix4x4[] dirShadowMatrices = new Matrix4x4[maxShadowedDirLightCount * maxCascades],
    ...
    readonly ShadowedDirectionalLight[] shadowedDirectionalLights = new ShadowedDirectionalLight[maxShadowedDirLightCount];
    ...
    readonly ShadowedOtherLight[] shadowedOtherLights = new ShadowedOtherLight[maxShadowedOtherLightCount];
    ...
    public void Render()
    {
        ...
        //为了避免当直射光数量为0，就直接不渲染区域光的阴影，我们需要增添次判断
